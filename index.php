...
<body>
    ...
    <?php if (isset($_SESSION["usuario"])): ?>
        ...
        <?php if ($_SESSION["usuario"]["rol"] === "admin"): ?>
            <a href="admin.php" class="btn-iniciar-sesion">Panel Admin</a>
        <?php endif; ?>

        <a href="logout.php" class="btn-destacado">Cerrar Sesión</a>
    ...
    <section id="recursos" class="caracteristicas">
    ...
    <p>
        En <strong>Mindfit</strong> creemos que el equilibrio entre cuerpo y mente
        es la clave para una vida saludable. Nuestra plataforma está diseñada para ayudarte
        a mejorar tu rendimiento físico, fortalecer tu salud mental y mantener hábitos
        de vida positivos.
    </p>

    <p>
        Este proyecto fue desarrollado por estudiantes que se le fue asignado un proyecto de la universidad de la utede ubicada en guadalajara de buga con el objetivo de brindar una
        herramienta accesible para el bienestar integral. Esperamos les sirva esta pagina, atentamente: Joel Cortes, Erick Castillo, Matt Manzano.
    </p>
</section>
